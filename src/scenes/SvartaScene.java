...
public class SvartaScene extends Scene{
    ...
    public void init() {
        ...
        mapChecker.addTeleportPad(new Position(0,11), 3, new Position(12,14));
    ...
    public void render() {
        ...
        garage.render();
        if(svartaPos.withinRadius(playerPos, 1) && Inventory.MATRACE > 0 && Renderer.questManager.hasQuest(4)) {
            Inventory.MATRACE = 0;
